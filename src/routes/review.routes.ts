...
import { createReview, deleteReview, getAllReviews, getReviewsForTour, getUserReviews } from '../controllers/review.controller';
...
router.get('/my', verifyToken, asHandler(getUserReviews));
